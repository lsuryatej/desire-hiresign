...
from sqlalchemy import Column, Integer, String, Text, Numeric, ForeignKey, Boolean, DateTime, Enum as SQLEnum
...
class Listing(Base):
    ...
    # Listing metadata
    status = Column(SQLEnum(ListingStatus, native_enum=False), default=ListingStatus.DRAFT, index=True)
