...
Revision ID: c1ce8e9a1684
Revises:
Create Date: 2025-10-26 12:27:11.481451
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("role", sa.Enum("DESIGNER", "HIRER", "ADMIN", name="userrole"), nullable=False),
